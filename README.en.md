...
Current release: `0.1.2` · Python `3.12+` · AGPL-3.0-only · SQLite single-instance reference deployment.
...
Version `0.1.2` is a single-instance reference product. It does not claim full Codex, Claude Code, MCP, or A2A compatibility, benchmark superiority, model-quality superiority, distributed queues, SSO, billing, Kubernetes deployment, or a production SLA.
